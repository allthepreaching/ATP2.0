...
<div class="flex flex-col items-center justify-start fixed top-16 w-[calc(100vw-289px)] h-full bg-black translate-x-72">
    ...
    <div class="w-full h-full flex flex-col items-start justify-start bg-black text-white fixed top-20 overflow-auto pt-4 pb-10">
        ...
        <div class="w-full flex flex-row items-center justify-left bg-black text-white px-2 relative">
            ...
            <!-- Arrows Overlay -->
            <div class="absolute inset-0 flex items-center justify-between -mx-4 pointer-events-none">

                <!-- Left Arrow -->
                <div class="arrow-left flex items-center justify-center opacity-50 bg-black rounded-full transition-all duration-300 hover:opacity-100 pointer-events-auto">
                    <svg class="w-16 h-16 hover:text-[#990000]" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M15 6L9 12L15 18" stroke="#ffffff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
                </div>
            ...
            <div class="flex flex-row overflow-x-auto mb-4 pb-4">
                ...
                <!-- Video Card -->
                <div class="w-[320px] h-auto flex flex-col items-start justify-start overflow-hidden mr-2 rounded-lg flex-shrink-0">

                    <!-- Video -->
                    <div class="w-full h-30 flex items-center justify-center rounded-full">
                        <video src="https://www.kjv1611only.com/video/01salvation/360_Video.mp4"></video>
                    </div>

                    <!-- Video Data -->
                    <div class="w-full h-50 flex flex-row items-center justify-start">
        ...
        <!-- Section Separator -->
        <div class="border-t-2 border-t-[#ffffff] w-11/12 my-2 mx-auto"></div>
    </div>
</div>