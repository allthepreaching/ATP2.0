...
<div class="flex flex-col items-center justify-start fixed h-full bg-black translate-y-16 transition-all duration-500" :class="{ 'w-full': !open, 'w-[calc(100vw-289px)] translate-x-72': open }">
    ...
    <div class="w-full h-full flex flex-col items-start justify-start bg-black text-white fixed top-20 overflow-auto pt-4 pb-10">
        ...
        <div class="w-full flex flex-row items-center justify-left bg-black text-white px-2 relative">
            ...
            <!-- Arrows Overlay -->
            <div class="absolute inset-0 flex items-center justify-between -mx-4 pointer-events-none z-30">

                <!-- Left Arrow -->
                <div class="arrow-left flex items-center justify-center opacity-50 bg-black rounded-full transition-all duration-300 hover:opacity-100 pointer-events-auto z-40">
