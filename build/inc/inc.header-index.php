...
<body class="relative bg-black" x-data="{ open: false }">
    ...
    <!-- Side Nav Container -->
    <div class="bg-black text-white h-screen w-72 fixed top-0 left-0 overflow-x-hidden overflow-y-auto z-10 flex-shrink-0 transition-all duration-500 md:block hidden" :class="{ 'w-0 invisible': !open, 'w-72 visible': open }" @click.away="open = false">
